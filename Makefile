build: 
	...
	gcc -m32 -ffreestanding -nostdlib -O0 -fno-omit-frame-pointer -mno-sse -mno-mmx -mno-80387 -fno-builtin -fno-pic -fno-pie -c kernel/kernel.c -o build/kernel.o
	gcc -m32 -ffreestanding -nostdlib -O0 -fno-omit-frame-pointer -mno-sse -mno-mmx -mno-80387 -fno-builtin -fno-pic -fno-pie -c kernel/interrupts.c -o build/interrupts.o
